...
import { TDateYYYYMMDD } from 'interfaces';
...
export const CharacterUnrestrictedUpdateSchema = z.optional(
    z.object({
        ...
        citations: z.array(CharacterRecordSchema)
            .optional(),

        arrests: z.array(CharacterRecordSchema)
            .optional(),

        warrants: z.array(CharacterRecordSchema)
            .optional()
    })
);
